...
import { PondSettings } from "./settingsView";
// Components
...
export default function Editor({
    ...
    darkMode?: boolean,
    selectedAvatarData: Pond.AvatarData,
}) {
    ...
    return (
        <div className={`${className} editor float-container`}>
            <div className="left-panel-header default-header select-none">
                ...
                <div className="flex gap-2">
                    <IconButton className="fa-solid fa-broom" tooltip="Format Script" onClick={formatScript}></IconButton>
                    {/* Toggle view button */}
