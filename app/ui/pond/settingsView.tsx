...
export class PondSettings {
    ...
    /** Array of avatars. Compatiable to AvatarData[] which is used in pond.js. */
    avatars = [
        { id: 1, name: "Player", loc: { x: 20, y: 80 }, color: '#ff9c00' },
        { id: 2, name: "Rook", loc: { x: 80, y: 80 }, color: '#da0026' },
        { id: 3, name: "Sniper", loc: { x: 80, y: 20 }, color: '#334079' },
        { id: 4, name: "Counter", loc: { x: 20, y: 20 }, color: '#277d1c' },
    ];
    editor = {
        tabWidth: 4,
    };
...
export default function SettingsView({
    ...
    const appendAvatar = () => {
        setTempSettings({
            ...tempSettings, avatars: [...tempSettings.avatars, {
                id: Date.now(),
                name: `Avatar ${tempSettings.avatars.length + 1}`,
                loc: { x: 0, y: 0 },
                color: '#ff9c00'
            }]
        });
