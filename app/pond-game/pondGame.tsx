...
export default function PondGame({
    ...
    // Settings currently used in the ongoing battle.
    const [inGameSettings, setInGameSettings] = useState(settings);
    ...
    return (
        <div className="flex flex-col gap-2 left-area select-none">
            ...
            <ControlBar
                ...
                isPaused={paused}
            />
            <PlayerList avatars={avatarInfo} onHighlightAvatar={handleAvatarHighlight} onSelectAvatar={handleAvatarSelection} />
        </div>
    );
}